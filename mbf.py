...
### Logo ###
logo = """\033[93m███╗░░░███╗██████╗░███████╗ 𝕸𝖆𝖘𝖘𝖆𝖑 𝕭𝖗𝖚𝖙𝖊 𝕱𝖔𝖗𝖈𝖊
████╗░████║██╔══██╗██╔════╝ 𝔘𝔭𝔡𝔞𝔱𝔢 𝔗𝔬𝔬𝔩𝔰 𝔖𝔦𝔫𝔠𝔢
██╔████╔██║██████╦╝█████╗░░ 2𝔨21-2𝔨22
██║╚██╔╝██║██╔══██╗██╔══╝░░
██║░╚═╝░██║██████╦╝██║░░░░░
...
def login():
    ...
    print('║╚═╝║╚╝║╚╝║║║║║║╔═╗║╚═╣╚═╣╚╝║╚╝║║║║╚╗')
    print('╚═══╩══╩═╗╠╩╝╚╝╚╝─╚╩══╩══╩══╩══╩╝╚╩═╝')
    print('───────╔═╝║𝑆𝑢𝑏𝑠𝑐𝑟𝑖𝑏𝑒 𝐶ℎ𝑎𝑛𝑛𝑒𝑙 𝑌𝑜𝑢𝑡𝑢𝑏𝑒')
    print('───────╚══╝𝑇𝑁.𝐻𝑈𝑅𝑇𝐸𝐷')
    print('==================================================')
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print('[x] File Tidak Ada')
					continue
				print('[•] Contoh Pass : aink,orangsunda')
				self.pwlist()
				break
			elif f=="t":
				try:
